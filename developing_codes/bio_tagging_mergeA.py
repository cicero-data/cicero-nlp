...
def get_parser(parser=argparse.ArgumentParser(
    description=
    "to BIO tagging on the pure texts for the mergeModelA, which convers information including names, phone numbers and fax numbers. The output file will be in the format of spaCy Doc file."
),):
    parser.add_argument(
        "--input_json",
        type=str,
